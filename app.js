...
fetch("https://randomuser.me/api/").then(res => res.json()).then(data => {
  ...
  page = data.info.page
  seed = data.info.seed
  displayUserInfo(userImg, userName, userEmail, page, seed)

  // console.log(userEmail,userImg,userName)
})


function displayUserInfo(userImg, userName, userEmail, page, seed) {

  // console.log(userName)
  const notesDiv = document.getElementById("user-info");
